...
import (
	...
	earthmodulev1 "earth/api/earth/earth/module"
	_ "earth/x/earth/module" // import for side-effects
	earthmoduletypes "earth/x/earth/types"
	...
	appConfig = appconfig.Compose(&appv1alpha1.Config{
		Modules: []*appv1alpha1.ModuleConfig{
			...
			},
			{
				...
				Config: appconfig.WrapAny(&earthmodulev1.Module{}),
			},
